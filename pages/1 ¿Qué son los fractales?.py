...
def main():
    ...
    expander.write("""\
        ...
        """)
    expander = st.expander("Nivel experto")
    expander.write("""\
        ...
        En cuanto a su aplicación en la práctica, los fractales se utilizan en una variedad de campos. En gráficos por computadora, se utilizan algoritmos fractales para generar paisajes, texturas y formas naturales de apariencia realista. En física, los fractales pueden describir fenómenos complejos, como la formación de fracturas en materiales sólidos o el comportamiento de los fluidos turbulentos. También se utilizan en biología para modelar estructuras naturales, como la distribución de ramas en un árbol o los patrones en la superficie de una hoja.
                """)
